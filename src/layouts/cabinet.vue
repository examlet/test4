...
<template>
  <div class="cabinet">
    <div
      class="cabinet__header"
    >
      <div
        class="cabinet__header_container"
      >
        <div
          class="cabinet__header_leftGroup"
        >
        ...
        <div class="cabinet__header_rightGroup">
          <div
            class="cabinet__header_userUuid"
          >
          ...
          <QDropdown>
            ...
            <template #content>
              <NuxtLink
                to="/cabinet/profile"
                class="cabinet__header_userLink"
              >
